...
public class JDBCConnectionPool {
  ...
  public static final class Builder extends NestedBuilder<JDBCConnectionPools, JDBCConnectionPool> {
    ...
    public Builder withSqlInit(final String sqlInit) {
      this.sqlInit = sqlInit;
      return this;
    }

    public Builder withSqlTest(final String sqlTest) {
    ...
    public Builder withMaximalPoolsSize(final int maximalPoolSize) {
